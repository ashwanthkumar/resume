  ...
  \cventry
    ...
    {Oct. 2016 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Currently working on our internal Data Services Platform to run our Big Data Workloads. }
        \item {Teah Lead on Product Matching - Enables Price Comparision use-cases and detecting duplicates on our Catalog. }
  ...
  \cventry
    ...
    {Oct. 2015 - Sept. 2016} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Worked with tools like - Ansible, Chef, Mesos, Marathon, Go.CD, Hadoop and AWS}
